  ...
  return function(random: Random) {
    ...
    return [
      ...
      random.pickone([
        ...
        `<path d="M2 13.104V9h1v2h1v1h1v1l-3 .104zM17 9h1v4.058L15 13v-1h1v-1h1V9zM2 7h1V4h1V3h1V2h10v1h1v1h1v3h1V3h-1V2h-1V1H4v1H3v1H2v4z" fill-rule="evenodd" fill="${hairColor}"/>`,
        ...
        `<path d="M3 4v3h1V4h2v1h1V4h1v1h1V4h7v3h1V4h1V2.016l-1-.046.01-.97H15v1H5V1H3.036L3 2l-1-.03V4h1z" fill="${hairColor}"/>`,
        `<path d="M2 10h1V8h1V7h1V6h1V5h1V4h7v1h3V4h-1V3h-1V2H4v1H3v1H2v6z" fill="${hairColor}"/>`,
        `<path d="M1 17h3v-1h4v-2H6v-1H5v-1H4v-1H3V9H2V7h1V5h1l-.002-1H11V3h1v1h1V3h1v1h1V3h1v2h1v2h1v2h-1v2h-1v1h-1v1h-1v1h-2v2h4v1h3V4h-1V3h-1V2h-1V1H4v1H3v1H2v1H1v13z" fill="${hairColor}"/>`,
